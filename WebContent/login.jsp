    ...
    <div id="login_wrap">
        <form name="form" action="<%=request.getContextPath()%>/login" method="post">
            <div
                ...
                Login</div>
            <br>
            <div style="padding: 10px; font-weight: 500; color: #444; font-size: 17px">

                <label style="float: left">Username <b>:</b></label>

                <div style="width: 75%;">
                    <label style="color: red; margin-left: 5%"><b>*</b></label> <input type="text" name="username"
                        required>
                </div>
                ...
                <div style="width: 75%;">
                    <label style="color: red; margin-left: 5%"><b>*</b></label> <input type="password" name="password"
                        required>
                </div>
                <br> <br> <br> <br>
            </div>
